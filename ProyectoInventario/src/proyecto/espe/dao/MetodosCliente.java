       ...
       List<Cliente> listaCliente = new ArrayList<>();
        ...
        try {
            ...
            for (Document temp : documentoCliente) {
                ...
                int id_Perfil = temp.getInteger("IdPerfil");
                Document perfil = (Document) coleccionPerfil.find(eq("id_perfil")).first();
                ...
                cliente.setIdPerfil(temp.getInteger("idPerfil"));
                cliente.setNombrePerfil(temp.getString("nombrePerfil"));
    ...
    public Cliente BuscarCedulaCliente(String cedula) {
        ...
        try {
            ...
            if (resultado != null) {
                ...
                cliente.setIdPerfil(resultado.getInteger("idPerfil"));
                cliente.setNombrePerfil(resultado.getString("nombrePerfil"));
    ...
    public boolean InsertarCliente(Cliente cliente) {
        ...
        try {
            documento = new Document("cedula", cliente.getCedula())
                    ...
                    .append("idPerfil", cliente.getIdPerfil());
