 ...
 * @author PC
 */
public class Cliente_Consultar_Empleado extends javax.swing.JInternalFrame {
    ...
    public Cliente_Consultar_Empleado() {
    ...
    private void btnModificarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarClienteActionPerformed
        codCedula = cliente.getCedula();
        Cliente_Modificar actualizar= new Cliente_Modificar();
        MenuEncargado.escritorioEcargado.add(actualizar);
        actualizar.toFront();
    ...
    private void txtBuscarClienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarClienteKeyTyped
        ...
        if (!Character.isDigit(validarCedula) || txtBuscarCliente.getText().length() == 10) {
            getToolkit().beep();
            evt.consume();
